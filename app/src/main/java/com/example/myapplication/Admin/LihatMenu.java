...
public class LihatMenu extends Fragment implements TabLayout.BaseOnTabSelectedListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_lihat_menu, container, false);
        ...
        ViewPagerAdapterLihatMenu adapter = new ViewPagerAdapterLihatMenu(getActivity().getSupportFragmentManager(), tabLayout.getTabCount());
