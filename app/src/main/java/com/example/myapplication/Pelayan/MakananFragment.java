...
public class MakananFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = v.findViewById(R.id.recyclerViewPelayanMakanan);
        imageView = v.findViewById(R.id.imageViewBottom);
        btnLeft = v.findViewById(R.id.arrowLeft);
        btnRight = v.findViewById(R.id.arrorRight);
...
//                            Toast.makeText(getContext(), ""+String.valueOf(menuModel.getHarga()), Toast.LENGTH_SHORT).show();
    ...
    private void loadData() {
        ...
        progressDialog.show();
        menuModelList.clear();
        StringRequest jsonObjectRequest = new StringRequest(Request.Method.GET, URLs.GETMAKANAN, new Response.Listener<String>() {
            @Override
