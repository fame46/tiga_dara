...
public class SelesaiDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_selesai_detail);

        preferences = new Preferences(this);

        btnSelesai = findViewById(R.id.btnSelesaiasw);
        recyclerView = findViewById(R.id.recyclerViewseleseiasw);
    ...
    private void loadData() {
        ...
        StringRequest jsonObjectRequest = new StringRequest(Request.Method.GET, URLs.GETANTARDETAIL+"?atasnama="+getIntent().getStringExtra("atasnama")+
    ...
    private void konfirmasi(){
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.ANTAR,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("atasnama", getIntent().getStringExtra("atasnama"));
                params.put("nomeja", getIntent().getStringExtra("nomeja"));
