...
public class MinumanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = v.findViewById(R.id.recyclerViewPelayanMinuman);
        imageView = v.findViewById(R.id.imageViewBottomMinuman);
        btnLeft = v.findViewById(R.id.arrowLeftMinuman);
        btnRight = v.findViewById(R.id.arrorRightMinuman);
        tvnama_menu = v.findViewById(R.id.tvNamaMenuBottomMinuman);
        tvhargaMenu = v.findViewById(R.id.tvHargaMenuBottomMinuman);
        tvjumlah = v.findViewById(R.id.tvJumlahMinuman);
        tvtotalHarga = v.findViewById(R.id.tvJumlahhargaMinuman);
        tvKeterangan = v.findViewById(R.id.tvKeteranganMinuman);
        btnMin = v.findViewById(R.id.btnMinMinuman);
        btnPlus = v.findViewById(R.id.btnPlusMinuman);
        btnPesan = v.findViewById(R.id.btnPesanMinuman);

        BottomSheet = v.findViewById(R.id.bottomSheetMinuman);
