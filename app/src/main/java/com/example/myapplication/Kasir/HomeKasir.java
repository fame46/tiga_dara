...
public class HomeKasir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_kasir);

        recyclerView = findViewById(R.id.recyclerViewKasir);
        btnLogout = findViewById(R.id.btnLogoutKasir);
    ...
    private void loadData() {
        ...
        StringRequest jsonObjectRequest = new StringRequest(Request.Method.GET, URLs.GETKASIR, new Response.Listener<String>() {
            @Override
